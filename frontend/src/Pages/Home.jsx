          ...
          <div className="flex flex-col lg:flex-row sm:flex-row lg:justify-start gap-8 sm:justify-center">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="border flex font-spacegroteskmedium items-center justify-center rounded-md px-7 py-4 border-black hover:bg-black hover:text-white"
              >
                <p>Browse Features</p>
              </button>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 p-10">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-2xl lg:h-64 lg:w-96 md:h-64 md:w-96 max-w-96">
              ...
              <div className=" font-spacegrotesklight text-center lg:text-start md:text-start">
                Speech therapy through AI. Boosting self confidence and
        ...
        <div>
          <div className="grid lg:grid-cols-2 grid-cols-1">
            <div className="lg:ml-20 flex flex-col gap-8 items-center justify-center">
              ...
              <div className="lg:text-4xl md:text-3xl text-xl p-1 lg:p-0 lg:text-start font-spacegrotesksemibold">
                Conversational AI and Progress Tracking
              </div>
              <div className="font-spacegroteskregular lg:text-xl md:text-xl text-sm lg:text-start  p-4 lg:p-0">
                Engages children in natural dialogue to boost confidence and
                social skills. Generates detailed reports for parents and
                therapists on the child’s improvements.
              </div>
            </div>
            <div className="hidden lg:flex justify-center">
